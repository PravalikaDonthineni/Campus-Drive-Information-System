...
<%!
 ...
 ResultSet rs=null;
 String lname,hnum,snam,bklog,br,byr,bagg,boi,ssc,dat,mon,yr,contact,email,que,ans;
 String sid=null,sid1=null;
 int i;
 %>
<%
 bklog=request.getParameter("sname16");
...
String str="update student set  fname='"+snam+"', branch='"+br+"', byear='"+byr+"',baggregate='"+bagg+"',backlogs='"+bklog+"',inter='"+boi+"',tenth='"+ssc+"' , day='"+dat+"' ,month='"+mon+"' ,year='"+yr+"',contactno='"+contact+"',email='"+email+"',lname='"+lname+"',question='"+que+"',answer='"+ans+"',approved='0'  where hno='"+sid1+"'";
