...
<%!
 ...
 Statement pst,pst1,pst2,pst3,pst4,pst5,pst6,pst7;
...
String exam7=null,uni7=null,year7=null;
%>
 <%
 try
 {
 ...
 pst7=con.createStatement();
 rs7=pst.executeQuery("select * from edu4 where hno='"+sid1+"'");
 while(rs7.next())
 {
 exam7=rs7.getString(1);
 uni7=rs7.getString(2);
 year7=rs7.getString(3);
 }
 //out.println("hi8");
...
<td align=center>Examination</td><td align=center>Board/University</td><td align=center>year</td><td align=center>Aggrigate</td></thead><tbody>
<tr><td><%=exam1%></td><td><%=uni1%></td><td><%=year1%></td><td><%=baggrigate%></td></tr>
...
Date :<%=date%>
					   ...
					   <a href="sud1.jsp"><font color="#2271A0">back</a>
</pre>
</form>
<%
}
